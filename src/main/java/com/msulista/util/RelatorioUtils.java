...
/**
 * Classe utilitária para auxiliar na geração de relatórios utilizando o Jasper Reports.
 */
public class RelatorioUtils {
     ...
     *
     * @param relatorioEnum {@link RelatorioEnum} indica o relatório que deve ser gerado
     * @param parametros Mapa que contém os parâmetros a serem passados para o Jasper Reports na geração do relatório.
     ...
     *
     * @param relatorioEnum {@link RelatorioEnum} indica o relatório que deve ser gerado
     * @param beanCollection {@link Collection} coleção de objetos a serem passados por parâmetro para geração do relatório.
     * @param parametros Mapa que contém os parâmetros a serem passados para o Jasper Reports na geração do relatório.
     * @return Array de bytes do relatório gerado.
     */
    @SuppressWarnings("rawtypes")
    public byte[] gerarRelatorioPdf(final RelatorioEnum relatorioEnum, final Collection beanCollection, final Map<String, Object> parametros) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public byte[] gerarRelatorioExcel(final RelatorioEnum relatorioEnum, final Collection beanCollection, final Map<String, Object> parametros) {
     ...
     * @param beanCollection {@link Collection} coleção de objetos a serem passados por parâmetro para geração do relatório.
     * @param parametros Mapa que contém os parâmetros a serem passados para o Jasper Reports na geração do relatório.
     * @param isPDF true quando o relatório será gerado em PDF. false quando será gerado em Excel.
     * @return Array de bytes do relatório gerado.
     */
    @SuppressWarnings("rawtypes")
    private byte[] geraRelatorio(final RelatorioEnum relatorioEnum, final Collection beanCollection, final Map<String, Object> parametros, final boolean isPDF) {
        ...
        try (OutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            final JRDataSource dataSource = beanCollection != null ? new JRBeanCollectionDataSource(beanCollection) : new JREmptyDataSource();
     ...
     *
     * @param jasperPrintList lista que contém os {@link JasperPrint} a serem utilizados na exportação.
     * @param outputStream {@link OutputStream} que irá contér o array de bytes do arquivo exportado.
     * @param isPDF true caso seja PDF, false caso seja Excel.
     * @return
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    private Exporter criarExporter(final List<JasperPrint> jasperPrintList, final OutputStream outputStream, final boolean isPDF) {
